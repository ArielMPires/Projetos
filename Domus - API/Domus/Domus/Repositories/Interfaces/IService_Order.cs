...
namespace Domus.Repositories.Interfaces
{
    public interface IService_Order
    {
        ...
        #region Services
        public Task<Return> NewService(Domus.Models.DB.Services service);
        public Task<List<Domus.Models.DB.Services>> ListAllService();
        public Task<Return> UpdateService(Domus.Models.DB.Services service);
        public Task<Return> DeleteService(int serviceId);
        public Task<Domus.Models.DB.Services> ServiceById(int serviceId);
        #endregion
        ...
        #region Service_rate
        public Task<bool> NewRate(Service_Rate rate);
        public Task<List<Service_Rate>> ListAllRate();
        public Task<List<Service_Rate>> ListByTechnical(int id);
        #endregion
    }
}
