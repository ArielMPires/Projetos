...
public partial class SH908 : ContentPage
{
    public SH908()
    {
        InitializeComponent();
        BindingContext = this.CreateViewModel<SH908ViewModel>();
    }
    ...
    protected override void OnAppearing()
    {
        ...
        if (DeviceInfo.Platform == DevicePlatform.Android || DeviceInfo.Platform == DevicePlatform.iOS)
            ...
            BindingContext = this.CreateViewModel<SH908ViewModel>(Convert.ToString(ID));
    }
